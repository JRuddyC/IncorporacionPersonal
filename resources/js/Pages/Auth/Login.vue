                ...
                <form action="#" class="sign-in-form">
                    ...
                    <div class="button-container">
                        <Button
                            ...
                            @click="submit"
                            label="ENTRAR"
                            class="btn solid w-full p-3"
                            :loading="form.processing"
                        ></Button>
                        <a
                            :href="route('register')"
                            class="btn transparent p-3"
                            id="sign-up-btn"
                            >REGISTRARSE</a
                        >
                    </div>
        ...
        <div class="panels-container">
            <div class="panel left-panel">
                <div class="content">
                    <h3>¡BIENVENIDO!</h3>
                    <p>
                        Disfruta de todas las funcionalidades que nuestro
                        sistema tiene para ofrecer.
                    </p>
                </div>
